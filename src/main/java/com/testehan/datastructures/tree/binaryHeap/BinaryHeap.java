...
public class BinaryHeap {
  ...
  // Heapify (means process to make sure that the BinaryHeap structure repects the properties of the BinaryHeap) for
  // Insert
  ...
  // heapifyTopToBottom - used in case of deletion/extraction of a node
